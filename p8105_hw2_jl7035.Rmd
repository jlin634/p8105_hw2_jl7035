...
Mr_Trash_Wheel_df <- 
  ...
  janitor::clean_names() %>% 
  mutate(Trash_Wheel_Type = rep("Mr. Trash Wheel", 
  times = nrow(Mr_Trash_Wheel_df)))
...
Professor_Trash_Wheel_df <-
  ...
  janitor::clean_names() %>%
  mutate(Trash_Wheel_Type = rep("Professor Trash Wheel", 
  times = nrow(Professor_Trash_Wheel_df)), 
  sports_balls = NA
  ) %>% 
...
Gwyn_Trash_Wheel_df <- 
  ...
  janitor::clean_names() %>% 
  mutate(
    Trash_Wheel_Type = rep("Gwynnda Trash Wheel", 
    times = nrow(Gwyn_Trash_Wheel_df)),
    sports_balls = NA, 
    glass_bottles = NA
  ) %>% 
  relocate(sports_balls, .before = homes_powered) %>% 
...
Trash_Wheel_df <- left_join(Mr_Trash_Wheel_df, Professor_Trash_Wheel_df)
Trash_Wheel_df <- left_join(Trash_Wheel_df, Gwyn_Trash_Wheel_df)
